...
<div class="card">
    <div class="card-header">
        <div class="card-title">                                
            <legend  class="fw-bolder"><?= __('Edit Enterprise Type') ?></legend>
        </div>
        <div class="card-toolbar"> 

                        <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $enterpriseType->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $enterpriseType->id), 'class' => 'btn btn-light-primary mx-2']
            ) ?>
