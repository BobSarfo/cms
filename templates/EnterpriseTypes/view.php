    ...
    <div class="card card-flush pt-3 mb-5 mb-xl-10">
        ...
        <div class="card-header">
            <div class="card-title">                
                    <h2 class="fw-bolder">Enterprise Types</h2>
            </div>
            <div class="card-toolbar"> 
                <?= $this->Html->link(__('Edit Enterprise Type'), ['action' => 'edit', $enterpriseType->id], ['class' => 'btn btn-light-primary mx-2']) ?>
                <?= $this->Form->postLink(__('Delete Enterprise Type'), ['action' => 'delete', $enterpriseType->id], ['confirm' => __('Are you sure you want to delete # {0}?', $enterpriseType->id), 'class' => ' btn btn-light-danger mx-2']) ?>
                <?= $this->Html->link(__('List Enterprise Types'), ['action' => 'index'], ['class' => 'btn btn-light-primary mx-2']) ?>
                <?= $this->Html->link(__('New Enterprise Type'), ['action' => 'add'], ['class' => 'btn btn-light-primary mx-2']) ?>
                            </div>
        </div>
        <div class="card-body pt-3">
            <div class="enterpriseTypes ">
                <h3><?= h($enterpriseType->name) ?></h3>
                ...
                <table class="table fs-6 fw-bold gs-0 gy-2 gx-2 m-0">
                        ...
                        <td  class="text-gray-800" ><?= h($enterpriseType->name) ?></td>
                    </tr > 
                                                                                                                                                                    <tr>
                        <th class="text-gray-400 "><?= __('Id') ?></th>
                        <td class="text-gray-800"><?= $this->Number->format($enterpriseType->id) ?></td>
                    </tr>
                                                                                                                </table>
                </div>
                </div>
                    ...
                    <div class="table-responsive">
                        ...
                        <?php if (!empty($enterpriseType->enterprises)) : ?>
                            <table class="table fs-6 fw-bold gs-0 gy-2 gx-2 m-0">
