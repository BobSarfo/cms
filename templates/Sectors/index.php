...
<div id="kt_content_container" class="container-xxl">
    ...
    <!--begin::Card header-->        
        <h3 class="card-header border-0 pt-6"><?= __('Sectors') ?></h3>
			...
			<div class="card-toolbar">
				...
				<div class="d-flex justify-content-end" data-kt-subscription-table-toolbar="base">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                     ...
                     <?= $this->Html->link(__('New Sector'), ['action' => 'add'], ['class' => 'btn btn-primary']) ?>
   					</span>
                        ...
                        <td class="text-end">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-2" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <?= $this->Html->link(__('View'), ['action' => 'view', $sector->id],['class'=>'menu-link px-3']) ?>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $sector->id],['class'=>'menu-link px-3']) ?>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item badge-light-danger px-3   ">
                                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $sector->id], ['class'=>'menu-link px-3','confirm' => __('Are you sure you want to delete # {0}?', $sector->id)]) ?>
                                </div>
                                <!--end::Menu item-->
                            </div>
                            <!--end::Menu-->
