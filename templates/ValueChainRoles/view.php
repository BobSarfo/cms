    ...
    <div class="card card-flush pt-3 mb-5 mb-xl-10">
        ...
        <div class="card-header">
            <div class="card-title">                
                    <h2 class="fw-bolder">Value Chain Roles</h2>
            </div>
            <div class="card-toolbar"> 
                <?= $this->Html->link(__('Edit Value Chain Role'), ['action' => 'edit', $valueChainRole->id], ['class' => 'btn btn-light-primary mx-2']) ?>
                <?= $this->Form->postLink(__('Delete Value Chain Role'), ['action' => 'delete', $valueChainRole->id], ['confirm' => __('Are you sure you want to delete # {0}?', $valueChainRole->id), 'class' => ' btn btn-light-danger mx-2']) ?>
                <?= $this->Html->link(__('List Value Chain Roles'), ['action' => 'index'], ['class' => 'btn btn-light-primary mx-2']) ?>
                <?= $this->Html->link(__('New Value Chain Role'), ['action' => 'add'], ['class' => 'btn btn-light-primary mx-2']) ?>
                            </div>
        </div>
        <div class="card-body pt-3">
            <div class="valueChainRoles ">
                <h3><?= h($valueChainRole->name) ?></h3>
                ...
                <table class="table fs-6 fw-bold gs-0 gy-2 gx-2 m-0">
                        ...
                        <td  class="text-gray-800" ><?= h($valueChainRole->name) ?></td>
                    </tr > 
                                                                                                                                                                    <tr>
                        <th class="text-gray-400 "><?= __('Id') ?></th>
                        <td class="text-gray-800"><?= $this->Number->format($valueChainRole->id) ?></td>
                    </tr>
                                                                                                                </table>
                </div>
                </div>
                    ...
                    <div class="table-responsive">
                        ...
                        <?php if (!empty($valueChainRole->actors)) : ?>
                            <table class="table fs-6 fw-bold gs-0 gy-2 gx-2 m-0">
                                ...
                                <?php foreach ($valueChainRole->actors as $actors) : ?>
                                <tr>
                                                                        <td><?= h($actors->id) ?></td>
                                                                        <td><?= h($actors->name) ?></td>
                    ...
                    <div class="table-responsive">
                        ...
                        <?php if (!empty($valueChainRole->enterprise_value_chain_roles)) : ?>
                            <table class="table fs-6 fw-bold gs-0 gy-2 gx-2 m-0">
                                ...
                                <?php foreach ($valueChainRole->enterprise_value_chain_roles as $enterpriseValueChainRoles) : ?>
                                <tr>
