...
<div class="card">
    <div class="card-header">
        <div class="card-title">                                
            <legend  class="fw-bolder"><?= __('Edit Enterprise Commodity') ?></legend>
        </div>
        <div class="card-toolbar"> 

                        <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $enterpriseCommodity->commodity_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $enterpriseCommodity->commodity_id), 'class' => 'btn btn-light-primary mx-2']
            ) ?>
