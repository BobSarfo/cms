 ...
 * @var \App\Model\Entity\EnterpriseCommodity[]|\Cake\Collection\CollectionInterface $enterpriseCommodities
 */
?>
<div id="kt_content_container" class="container-xxl">
    ...
    <!--begin::Card header-->        
        <h3 class="card-header border-0 pt-6"><?= __('Enterprise Commodities') ?></h3>
