    ...
    <div class="card card-flush pt-3 mb-5 mb-xl-10">
        ...
        <div class="card-header">
            <div class="card-title">                
                    <h2 class="fw-bolder">Organisations</h2>
            </div>
            <div class="card-toolbar"> 
                <?= $this->Html->link(__('Edit Organisation'), ['action' => 'edit', $organisation->id], ['class' => 'btn btn-light-primary mx-2']) ?>
                <?= $this->Form->postLink(__('Delete Organisation'), ['action' => 'delete', $organisation->id], ['confirm' => __('Are you sure you want to delete # {0}?', $organisation->id), 'class' => ' btn btn-light-danger mx-2']) ?>
                <?= $this->Html->link(__('List Organisations'), ['action' => 'index'], ['class' => 'btn btn-light-primary mx-2']) ?>
                <?= $this->Html->link(__('New Organisation'), ['action' => 'add'], ['class' => 'btn btn-light-primary mx-2']) ?>
                            </div>
        </div>
            ...
            <div class="organisations ">
                ...
                <table class="table fs-6 fw-bold gs-0 gy-2 gx-2 m-0">
                    ...
                    <div class="table-responsive">
                        ...
                        <?php if (!empty($organisation->actors)) : ?>
                            <table class="table fs-6 fw-bold gs-0 gy-2 gx-2 m-0">
                ...
                <div class="d-flex flex-wrap py-5">
                    ...
                    <div class="table-responsive">
                        ...
                        <?php if (!empty($organisation->commodities)) : ?>
                            <table class="table fs-6 fw-bold gs-0 gy-2 gx-2 m-0">
