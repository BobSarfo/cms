        ...
        <div class="card-body pt-3">
            <div class="enterprises ">
                ...
                <table class="table fs-6 fw-bold gs-0 gy-2 gx-2 m-0">
                    ...
                    <!--begin::Row-->
                    <div class="table-responsive">
                        <h5 class="mb-4"><?= __('Related Enterprise Commodities') ?></h5>
                        <?php if (!empty($enterprise->enterprise_commodities)) : ?>
                            <table class="table fs-6 fw-bold gs-0 gy-2 gx-2 m-0">
                            
                                <tr class="border-bottom border-gray-200 text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                                                        <th class="min-w-125px"><?= __('Enterprise Id') ?></th>
                                                                        <th class="min-w-125px"><?= __('Commodity Id') ?></th>
                                                                        <th class="text-end min-w-125px actions"><?= __('Actions') ?></th>
                                </tr>
                                <?php foreach ($enterprise->enterprise_commodities as $enterpriseCommodities) : ?>
                                <tr>
                                                                        <td><?= h($enterpriseCommodities->enterprise_id) ?></td>
                                                                        <td><?= h($enterpriseCommodities->commodity_id) ?></td>
                                                                                                            <td class="text-end min-w-125px actions">
                                        <!--begin::Action-->
                                        <a href="#" class="btn btn-icon btn-active-light-primary w-30px h-30px" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
                                            <!--begin::Svg Icon | path: icons/duotune/general/gen019.svg-->
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-6 w-200px py-4" data-kt-menu="true" style="">
                                            ...
                                            <div class="menu-item px-3"> 
                                                <?= $this->Html->link(__('View'), ['controller' => 'EnterpriseCommodities', 'action' => 'view', $enterpriseCommodities->commodity_id]) ?>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <?= $this->Html->link(__('Edit'), ['controller' => 'EnterpriseCommodities', 'action' => 'edit', $enterpriseCommodities->commodity_id]) ?>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <?= $this->Form->postLink(__('Delete'), ['controller' => 'EnterpriseCommodities', 'action' => 'delete', $enterpriseCommodities->commodity_id], ['confirm' => __('Are you sure you want to delete # {0}?', $enterpriseCommodities->commodity_id)]) ?>
                                            </div>
                                            <!--end::Menu item-->
                                        </div>
                                        <!--end::Menu-->
                    ...
                    <!--begin::Row-->
                    <div class="table-responsive">
                        <h5 class="mb-4"><?= __('Related Enterprise Value Chain Roles') ?></h5>
                        <?php if (!empty($enterprise->enterprise_value_chain_roles)) : ?>
                            <table class="table fs-6 fw-bold gs-0 gy-2 gx-2 m-0">
                            
                                <tr class="border-bottom border-gray-200 text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                                                        <th class="min-w-125px"><?= __('Enterprise Id') ?></th>
                                                                        <th class="min-w-125px"><?= __('Value Chain Role Id') ?></th>
                                                                        <th class="text-end min-w-125px actions"><?= __('Actions') ?></th>
                                </tr>
                                <?php foreach ($enterprise->enterprise_value_chain_roles as $enterpriseValueChainRoles) : ?>
                                <tr>
                                                                        <td><?= h($enterpriseValueChainRoles->enterprise_id) ?></td>
                                                                        <td><?= h($enterpriseValueChainRoles->value_chain_role_id) ?></td>
                                                                                                            <td class="text-end min-w-125px actions">
                                        <!--begin::Action-->
                                        <a href="#" class="btn btn-icon btn-active-light-primary w-30px h-30px" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
                                            <!--begin::Svg Icon | path: icons/duotune/general/gen019.svg-->
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-6 w-200px py-4" data-kt-menu="true" style="">
                                            ...
                                            <div class="menu-item px-3"> 
                                                <?= $this->Html->link(__('View'), ['controller' => 'EnterpriseValueChainRoles', 'action' => 'view', $enterpriseValueChainRoles->value_chain_role_id]) ?>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <?= $this->Html->link(__('Edit'), ['controller' => 'EnterpriseValueChainRoles', 'action' => 'edit', $enterpriseValueChainRoles->value_chain_role_id]) ?>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <?= $this->Form->postLink(__('Delete'), ['controller' => 'EnterpriseValueChainRoles', 'action' => 'delete', $enterpriseValueChainRoles->value_chain_role_id], ['confirm' => __('Are you sure you want to delete # {0}?', $enterpriseValueChainRoles->value_chain_role_id)]) ?>
                                            </div>
                                            <!--end::Menu item-->
                                        </div>
                                        <!--end::Menu-->
