...
<head>
    ...
    <body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed" style="--kt-toolbar-height:10px;--kt-toolbar-height-tablet-and-mobile:10px">
    <!--begin::Main-->
    <!--begin::Root-->
				...
				<div class=" wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
					...
					<div id="kt_header" class="header align-items-stretch">
						...
						<div class="container-xxl d-flex align-items-stretch justify-content-between">
							...
							<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0 me-lg-15">
								<a href="#">
									<img alt="Logo" src="/img/logo-1.png" class="h-20px h-lg-30px" />
								</a>
							</div>
							<!--end::Logo-->
							<!--begin::Wrapper-->
										...
										<div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch" id="#kt_header_menu" data-kt-menu="true">
											...
											<div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion me-lg-1">
												<span class="menu-link py-3">
													<span class="menu-title">App Modules</span>
													<span class="menu-arrow d-lg-none"></span>
												</span>
												<!-- Start::Value Chain Actors -->
												<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
													<div class="menu-item">
														<span class="menu-link py-3">
															...
															<a href="/actors">
																<span class="menu-title">Value Chain Actors</span>
															</a>
														</span>
													</div>
													<!-- End::ValueChainActors -->
													<div class="menu-item">
														<span class="menu-link py-3">
															<span class="menu-icon">
																<!--begin::Svg Icon | path: icons/duotune/graphs/gra006.svg-->
															...
															<a href="/enterprises">
																<span class="menu-title">Enterprises</span>
															</a>
														</span>
													</div>
													<div class="menu-item">
													...
													<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
														...
														<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
															<div class="menu-item">
																<a class="menu-link py-3" href="/genders">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
																	<span class="menu-title">Manage Gender</span>
																</a>
															</div>
															<div class="menu-item">
																<a class="menu-link py-3" href="/communities">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
																	<span class="menu-title">Manage Communities</span>
																</a>
															</div>
															<div class="menu-item">
																<a class="menu-link py-3" href="/sectors">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
																	<span class="menu-title">Manage Agric Sectors</span>
																</a>
															</div>
															<div class="menu-item">
																<a class="menu-link py-3" href="/disabilities">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
																	<span class="menu-title">Manage Disabilities</span>
																</a>
															</div>
															<div class="menu-item">
																<a class="menu-link py-3" href="commodities">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
																	<span class="menu-title">Manage Commodities</span>
																</a>
															</div>
															<div class="menu-item">
																<a class="menu-link py-3" href="/productionscalescontroller">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
																	<span class="menu-title">Manage Production Scale</span>
																</a>
															</div>
															<div class="menu-item">
																<a class="menu-link py-3" href="/departments">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
																	<span class="menu-title">Manage User Departments</span>
																</a>
															</div>
														</div>
													</div>
													<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
														<span class="menu-link py-3">
															...
															<span class="menu-title">Summaries</span>
															<span class="menu-arrow"></span>
														</span>
														<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
															<div class="menu-item">
																<a class="menu-link py-3" href="/enterprisecommodities">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
																	<span class="menu-title">Enterprise Commodities</span>
																</a>
															</div>
															<div class="menu-item">
									...
									<div class="d-flex align-items-stretch flex-shrink-0">
										...
										<div class="d-flex align-items-center ms-1 ms-lg-3">
											...
											<div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px" data-kt-menu="true">
												<!--begin::Heading-->
												<div class="d-flex flex-column flex-center bgi-no-repeat rounded-top px-9 py-10" style="background-image:url('/img/pattern-1.jpg')">
													<!--begin::Title-->
										...
										<div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
											...
											<div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
												<img src="/img/blank.png" alt="user" />
											</div>
											<!--begin::Menu-->
											<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
												...
												<div class="menu-item px-3">
													<div class="menu-content d-flex align-items-center px-3">
														...
														<div class="symbol symbol-50px me-5">
															<img alt="Logo" src="/img/blank.png" />
														</div>
														<!--end::Avatar-->
														<!--begin::Username-->
														<div class="d-flex flex-column">
															...
															<a href="#" class="fw-bold text-muted text-hover-primary fs-7"><?php																	
																	$session=$this ->request->getSession();
																	$login_user_details= $session->read('auth-role');
																	echo $login_user_details;
																?></a>
														</div>
														<!--end::Username-->
													</div>
												...
												<div class="menu-item px-5 my-1">
													<a href="/users/changepassword" class="menu-link px-5">Account Settings</a>
												</div>
												<!--end::Menu item-->
												<!--begin::Menu item-->
												<div class="menu-item px-5">
													<a href="/users/logout" class="menu-link px-5">Sign Out</a>
												</div>
												<!--end::Menu item-->
											</div>
											<!--end::Menu-->
                    ...
                    <div class="content d-flex flex-column flex-column-fluid pt-0" id="kt_content">
                        ...
                        <div class="" id="kt_toolbar">
                            <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack p-2">
    ...
    <?= $this->Html->script(['plugins.bundle','scripts.bundle','datatables.bundle','general','list']) ?>
    <?= $this->fetch('script') ?>
