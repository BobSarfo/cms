        ...
        <div class="card-body pt-3">
            <div class="commodities ">
                ...
                <table class="table fs-6 fw-bold gs-0 gy-2 gx-2 m-0">
                        ...
                        <td class="text-gray-800"><?= $this->Number->format($commodity->id) ?></td>
                    </tr>
                                                                                                                </table>
                </div>
                </div>
                    ...
                    <div class="table-responsive">
                        ...
                        <?php if (!empty($commodity->enterprise_commodities)) : ?>
                            <table class="table fs-6 fw-bold gs-0 gy-2 gx-2 m-0">
                                ...
                                <?php foreach ($commodity->enterprise_commodities as $enterpriseCommodities) : ?>
                                <tr>
