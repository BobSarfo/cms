 ...
 * @var \App\Model\Entity\ActorsValueChainRole[]|\Cake\Collection\CollectionInterface $actorsValueChainRoles
 */
?>
<div id="kt_content_container" class="container-xxl">
    ...
    <!--begin::Card header-->        
        <h3 class="card-header border-0 pt-6"><?= __('Actors Value Chain Roles') ?></h3>
        ...
        <div class="table-responsive">
            <table class="table align-middle table-row-dashed fs-6 gy-2" id="kt_subscriptions_table">
                ...
                <tbody class="text-gray-600 fw-bold">
                    <?php foreach ($actorsValueChainRoles as $actorsValueChainRole): ?>
                    <tr>
                                                                                                                                                                                                <td><?= $actorsValueChainRole->has('actor') ? $this->Html->link($actorsValueChainRole->actor->name, ['controller' => 'Actors', 'action' => 'view', $actorsValueChainRole->actor->id]) : '' ?></td>
                                                                                                                                                                                                                                                                                                                                                                                                                                <td><?= $actorsValueChainRole->has('value_chain_role') ? $this->Html->link($actorsValueChainRole->value_chain_role->name, ['controller' => 'ValueChainRoles', 'action' => 'view', $actorsValueChainRole->value_chain_role->id]) : '' ?></td>
                                                                                                                                                                                                <!--begin::Action=-->
