    ...
    <div class="card card-flush pt-3 mb-5 mb-xl-10">
        ...
        <div class="card-header">
            <div class="card-title">                
                    <h2 class="fw-bolder">Communities</h2>
            </div>
            <div class="card-toolbar"> 
                <?= $this->Html->link(__('Edit Community'), ['action' => 'edit', $community->id], ['class' => 'btn btn-light-primary mx-2']) ?>
                <?= $this->Form->postLink(__('Delete Community'), ['action' => 'delete', $community->id], ['confirm' => __('Are you sure you want to delete # {0}?', $community->id), 'class' => ' btn btn-light-danger mx-2']) ?>
                <?= $this->Html->link(__('List Communities'), ['action' => 'index'], ['class' => 'btn btn-light-primary mx-2']) ?>
                <?= $this->Html->link(__('New Community'), ['action' => 'add'], ['class' => 'btn btn-light-primary mx-2']) ?>
                            </div>
        </div>
            ...
            <div class="communities ">
                ...
                <table class="table fs-6 fw-bold gs-0 gy-2 gx-2 m-0">
                    ...
                    <div class="table-responsive">
                        ...
                        <?php if (!empty($community->enterprises)) : ?>
                            <table class="table fs-6 fw-bold gs-0 gy-2 gx-2 m-0">
                    ...
                    <div class="table-responsive">
                        ...
                        <?php if (!empty($community->organisations)) : ?>
                            <table class="table fs-6 fw-bold gs-0 gy-2 gx-2 m-0">
