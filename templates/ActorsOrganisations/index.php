 ...
 * @var \App\Model\Entity\ActorsOrganisation[]|\Cake\Collection\CollectionInterface $actorsOrganisations
 */
?>
<div id="kt_content_container" class="container-xxl">
    ...
    <!--begin::Card header-->        
        <h3 class="card-header border-0 pt-6"><?= __('Actors Organisations') ?></h3>
        ...
        <div class="table-responsive">
            <table class="table align-middle table-row-dashed fs-6 gy-2" id="kt_subscriptions_table">
                ...
                <tbody class="text-gray-600 fw-bold">
                    <?php foreach ($actorsOrganisations as $actorsOrganisation): ?>
                    <tr>
                                                                                                                                                                                                <td><?= $actorsOrganisation->has('organisation') ? $this->Html->link($actorsOrganisation->organisation->name, ['controller' => 'Organisations', 'action' => 'view', $actorsOrganisation->organisation->id]) : '' ?></td>
                                                                                                                                                                                                                                                                                                                                                                                                                                <td><?= $actorsOrganisation->has('actor') ? $this->Html->link($actorsOrganisation->actor->name, ['controller' => 'Actors', 'action' => 'view', $actorsOrganisation->actor->id]) : '' ?></td>
                                                                                                                                                                                                <!--begin::Action=-->
