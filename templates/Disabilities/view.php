    ...
    <div class="card card-flush pt-3 mb-5 mb-xl-10">
        ...
        <div class="card-header">
            <div class="card-title">                
                    <h2 class="fw-bolder">Disabilities</h2>
            </div>
            <div class="card-toolbar"> 
                <?= $this->Html->link(__('Edit Disability'), ['action' => 'edit', $disability->id], ['class' => 'btn btn-light-primary mx-2']) ?>
                <?= $this->Form->postLink(__('Delete Disability'), ['action' => 'delete', $disability->id], ['confirm' => __('Are you sure you want to delete # {0}?', $disability->id), 'class' => ' btn btn-light-danger mx-2']) ?>
                <?= $this->Html->link(__('List Disabilities'), ['action' => 'index'], ['class' => 'btn btn-light-primary mx-2']) ?>
                <?= $this->Html->link(__('New Disability'), ['action' => 'add'], ['class' => 'btn btn-light-primary mx-2']) ?>
                            </div>
        </div>
        <div class="card-body pt-3">
            <div class="disabilities ">
                ...
                <table class="table fs-6 fw-bold gs-0 gy-2 gx-2 m-0">
                        ...
                        <td  class="text-gray-800" ><?= h($disability->name) ?></td>
                    </tr > 
                                                                                                                                                                    <tr>
                        <th class="text-gray-400 "><?= __('Id') ?></th>
                        <td class="text-gray-800"><?= $this->Number->format($disability->id) ?></td>
                    </tr>
                                                                                                                </table>
                </div>
                </div>
                    ...
                    <div class="table-responsive">
                        ...
                        <?php if (!empty($disability->actors)) : ?>
                            <table class="table fs-6 fw-bold gs-0 gy-2 gx-2 m-0">
                                ...
                                <?php $i=0 ?>
                                <?php foreach ($disability->actors as $actors) : ?>
                                <tr>
                                     <td><?= h(++$i) ?></td>
                                    <td><?= h($actors->name) ?></td>
